...
class ReservationUpload(ModelForm):
    ...
    def clean(self):
        ...
        if overlapping_reservations >= inventory.quantity:
            ...
            self.add_error("room_type", _("Brak dostępnych pokoi typu {room_type}. Najbliższy wolny termin to: {next_available_date}.").format(room_type=room_type, next_available_date=next_available_date))
